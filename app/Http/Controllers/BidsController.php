...
class BidsController extends Controller
{
    ...
    public function createBid(Request $request)
    {
        ...
        if($buyer->pcoins >= $formfields["buyer_bid"]) {
            ...
            if(Bid::where('post_id', '=', $formfields["post_id"])->where('bid_status', '<>', 'Accepted')->where('bid_status', '<>', 'Rejected')->exists()) {
                $bids = Bid::where('post_id', '=', $formfields["post_id"])->where('bid_status', '<>', 'Accepted')->where('bid_status', '<>', 'Rejected')->get();
